...
static struct nvec_power_platform_data nvec_power_pdata = {
	.low_batt_irq = TEGRA_GPIO_TO_IRQ(ADAM_LOW_BATT),	/* If there is a low battery IRQ */
	.in_s3_state_gpio = ADAM_IN_S3,						/* Gpio pin used to flag that system is suspended */
...
static struct platform_device adam_nvec_mfd = {
	.name = "nvec",
	.dev = {
