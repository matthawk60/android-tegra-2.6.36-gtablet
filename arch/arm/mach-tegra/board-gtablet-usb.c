/*
 * arch/arm/mach-tegra/board-gtablet-usb.c
 *
...
static struct tegra_ulpi_config ulpi_phy_config = {
	.reset_gpio = TEGRA_GPIO_PG2, //GTABLET_USB1_RESET,
...
static struct platform_device *gtablet_usb_devices[] __initdata = {
#ifdef CONFIG_USB_ANDROID_ACM	
...
int __init gtablet_usb_register_devices(void)
{
	int ret;
...
//	tegra_usb_phy_init(tegra_usb_phy_pdata, ARRAY_SIZE(tegra_usb_phy_pdata));
	...
	ret = platform_add_devices(gtablet_usb_devices, ARRAY_SIZE(gtablet_usb_devices));
//	if (ret)
	return ret;
