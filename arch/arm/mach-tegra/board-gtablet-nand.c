...
static struct tegra_nand_chip_parms gtablet_nand_chip_parms[] = {
	/* Samsung K5E2G1GACM */
	[0] = {
		.vendor_id   = 0xEC,
		.device_id   = 0xAA,
...
static struct tegra_nand_platform gtablet_nand_data = {
	.max_chips	= 8,
	.chip_parms	= gtablet_nand_chip_parms,
	.nr_chip_parms  = ARRAY_SIZE(gtablet_nand_chip_parms),
	.parts		= gtablet_nand_partitions,
	.nr_parts	= ARRAY_SIZE(gtablet_nand_partitions),
};
...
struct platform_device tegra_nand_device = {
	...
	.dev            = {
		.platform_data = &gtablet_nand_data,
	},
};

int __init gtablet_nand_register_devices(void)
{

	/* Enable writes on NAND */
	gpio_request(GTABLET_NAND_WPN, "nand_wp#");
	gpio_direction_output(GTABLET_NAND_WPN, 1);
