/*
 * arch/arm/mach-tegra/board-gtablet-clocks.c
 *
...
/* Be careful here: Most clocks have restrictions on parent and on
   ...
   this table ! */
static __initdata struct tegra_clk_init_table gtablet_clk_init_table[] = {
...
void __init gtablet_clks_init(void)
{
	tegra_clk_init_from_table(gtablet_clk_init_table);
}
