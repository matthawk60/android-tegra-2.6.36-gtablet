...
static struct i2c_board_info __initdata gtablet_i2c_bus2_sensor_info[] = {
	{
...
int __init gtablet_sensors_register_devices(void)
{
	...
	i2c_register_board_info(0, gtablet_i2c_bus0_sensor_info,
	                        ARRAY_SIZE(gtablet_i2c_bus0_sensor_info));
	return i2c_register_board_info(2, gtablet_i2c_bus2_sensor_info,
	                               ARRAY_SIZE(gtablet_i2c_bus2_sensor_info));
}
